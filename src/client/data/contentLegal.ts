export const staticContent:any = {
  Terms: {
    ...
    <h6>Folosirea acestui site implica acceptarea termenilor si conditiilor de mai jos. Recomandam citirea cu atentie a acestora. montanair s.r.l isi asuma dreptul de a modifica aceste prevederi fara o alta notificare. Cea mai recenta versiune poate fi accesata in aceasta pagina.</h6>
                ...
                <h6><b>DIN MUNTI STRABUNI s.r.l</b> <br>garanteaza utilizatorului acces limitat, in interes personal (efectuarea de comenzi online, informare), pe site-ul <b> www.montanair.ro </b> si nu ii confera dreptul de a descarca sau de a modifica partial sau integral site-ul, de a reproduce partial sau integral site-ul, de a copia, de a vinde/revinde sau de a exploata site-ul in orice alta maniera, in scopuri comerciale sau fara acordul prealabil scris al acesteia.</h6>
                <h6>Intregul continut al site-ului <b> www.montanair.ro </b> - imagini, texte, grafice, simboluri, elemente de grafica web, email-uri, scripturi, programe si alte date - este proprietatea <b>DIN MUNTI STRABUNI s.r.l</b> si a furnizorilor sai si este aparat de Legea pentru protectia drepturilor de autor (legea nr. 8/1996) si de legile privind</h6>
                <h6>proprietatea intelectuala si industriala. Folosirea fara acordul propietarului <b>DIN MUNTI STRABUNI s.r.l</b> a oricaror elemente enumerate mai sus se pedepseste conform legislatiei in vigoare.</h6>
                <h6>Domeniul <b> www.montanair.ro  </b> este detinut de catre <b>DIN MUNTI STRABUNI s.r.l</b> Utilizarea acestei marci, a domeniului sau a numelor de comercializare, siglelor si emblemelor, in forma directa sau "ascunsa" (de tipul, dar nu limitat la, meta taguri sau alte tehnici de indexare, cautare web) fara permisiunea prealabila scrisa este interzisa si se pedepseste conform legii.</h6>
                <h6>Produsele prezentate pe <b> www.montanair.ro </b> sunt si comercializare de <b>DIN MUNTI STRABUNI s.r.l</b> Preturile produselor pot fi schimbate oricand. Verificati pretul final de vanzare inainte de a achizitiona un produs.</h6>
