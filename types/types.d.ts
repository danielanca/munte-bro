...
declare module "react-star-ratings" {
  ...
  export interface StarRatingsProps {
    ...
    starDimension?: string; // e.g. "18px"
    starSpacing?: string;   // e.g. "2px"
    numberOfStars?: number; // default 5
    name?: string;
    svgIconPath?: string;
  ...
  const StarRatings: React.FC<Partial<StarRatingsProps>>;
...
declare module "shards-react" {
  ...
  export const Modal: React.FC<
    React.HTMLAttributes<HTMLDivElement> & { open?: boolean; toggle?: () => void }
  >;
  ...
  export const Tooltip: React.FC<
    { open?: boolean; target?: string; toggle?: () => void } & React.HTMLAttributes<HTMLDivElement>
  >;
